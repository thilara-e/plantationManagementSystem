    ...
    return (
      ...
      <div>
        <GridContainer>
          ...
          <Card>
            ...
            <Link to ={"/addDivision"}>
              <CardHeader color="success" stats icon>
                ...
                <h4 className={classes.cardTitle}>Add Division</h4>
              </CardHeader>
              <CardFooter stats>
          ...
          <Card>
            <button>
            <Link to ={"/updateDivision"}>
              <CardHeader color="info" stats icon>
                <CardIcon color="info">
                <Accessibility />
                </CardIcon>
                <p className={classes.cardCategory}></p>
                <h4 className={classes.cardTitle}>Update Division</h4>
              </CardHeader>
              <CardFooter stats>
                <div className={classes.stats}>
               <hr/>
          ...
          <Card>
            <button>
            <Link to ={"/deleteDivision"}>
              <CardHeader color="danger" stats icon>
                <CardIcon color="danger">
                <i class="material-icons">delete</i>
                </CardIcon>
                <p className={classes.cardCategory}></p> 
                <h4 className={classes.cardTitle}>Delete Division</h4>
              </CardHeader>
              <CardFooter stats>
                <div className={classes.stats}>
                  <hr/>                 
