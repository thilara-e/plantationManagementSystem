...
export default class Loan extends Component {
  ...
  handleSubmit = () => {
    ...
    // console.log(labourers.descriptions);
    // console.log(labourers.divExpenseID);
    // axios({
    //   method: 'post',
    //   url: 'http://localhost:8000/api/expenses/insert',
    //   data: {
    //     divExpenseID:labourers.divExpenseID,
    //     divNo: "division 1",
    //     expenseID: "1",
    //     descriptions:labourers.descriptions,
    //     date: this.getDate(),
    //     amount:labourers.amount,
    ...
    labourers.forEach((labourer) => {
      firebase.database().ref("Loan_request").child(date).child(division).child(labourer.descriptions).update({
        amount: labourer.amount
      });
    })
  }
...
<div className="wrap" > 
  <h2 className="title">Loan Request</h2>
          <form className="form">
            <hr/>
