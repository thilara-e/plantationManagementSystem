...
class Register extends Component {
  ...
  handleLoad = async (e) => {
    ...
    await axios
      .get("http://localhost:8000/api/clerk/get/" + this.state.tempPhone)
      .then(response => {
        ...
        if (response.data["mobile"]) {
          ...
          alert("Please insert an existing clerk");
